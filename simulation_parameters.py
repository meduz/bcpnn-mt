...
#        self.params['N_V'], self.params['N_theta'] = 1, 8# resolution in velocity norm and direction
        ...
        self.params['sigma_RF_speed'] = .2 # some variability in the speed of RFs
...
#        tau_p = self.params['t_sim'] * 0.33 # * self.n_stim# * self.n_cycles # tau_p should be in the order of t_stimulus * n_iterations * n_cycles
        ...
        self.params['v_min_tp'] = 0.1  # [a.u.] minimal velocity in visual space for training
...
#        folder_name = 'LargeScaleModel_'
        ...
        if self.params['connect_exc_exc']:
            ...
            folder_name += 'noRec_'
        folder_name += "delayScale%d_blurX%.2e_blurV%.2e_wsigmax%.2e_wsigmav%.2e_wtgtin%.2f/" % \
                        (self.params['delay_scale'], self.params['blur_X'], self.params['blur_V'], self.params['w_sigma_x'], self.params['w_sigma_v'], self.params['w_tgt_in'])
